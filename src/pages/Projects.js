...
export default function Projects() {
    return (
            <Fragment>
                ...
                <Card.Img className='card-image' variant="top" src="./image/Farmers-PH.png" />
                <Card.Body>
                    <Card.Title>FarmersPH</Card.Title>
                    <Card.Text>
                    An E-commerce prototype app build with ReactJs for frontend and NodeJs, express.js and MongoDB for backend.
                    </Card.Text>
                    <div>
                    <a className='farmers-btn' role='button' aria-pressed='true' target='_blank' href='https://farmers-ph-shop.netlify.app/'>Visit Site</a>       
                    </div>
                </Card.Body>
                </Card>
                </Col>
                ...
                <Card.Body>
                    <Card.Title>E-commerce API</Card.Title>
                    <Card.Text>
